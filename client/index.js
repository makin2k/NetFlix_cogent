...
return `
        <div class="movie">
          <img class="movie-photo" src="${movie.poster}">
          <h2>${movie.title} (${movie.year})</h2>
          <p><strong>Rated:</strong> ${movie.rated}</p>
          <p><strong>Genre:</strong> ${movie.genre}</p>
          <p><strong>Director:</strong> ${movie.director}</p>
          <div class="tooltip"><strong>IMDB Rating:</strong>${movie.imdbRating}
          <span class="tooltiptext">Movie ID: ${movie.imdbId}<br>
          No. of Votes:${movie.imdbVotes}</span></div>
...
document.getElementById("app").innerHTML = `
  <h1 class="app-title">MyFlix Movies</h1>

  

  ${movieData.map(movieTemplate).join("")}

  <p class="footer"> This is a dummy footer</p>
